...
Use the **X** and **Y** buttons to scroll through long text products.

Some area weather products on NOAA's server don't allow HTTPS requests, so the app fetches them over plain HTTP.
